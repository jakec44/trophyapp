/* Fix: ensure up_votes and down_votes never go negative (avoids CHECK constraint violation) */
...
BEGIN
  ...
  /* Clamp to avoid CHECK constraint violations when counts are out of sync */
